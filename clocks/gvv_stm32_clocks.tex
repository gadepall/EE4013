...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=\columnwidth]{./figs/rcc_cr}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=\columnwidth]{./figs/rcc_cfgr}
\end{center}
\caption{RCC clock Configuration Register (RCC$->$CFGR)}
\label{fig:rcc_cfgr}
\end{figure}
\begin{problem}
Verify that HSE is the system clock by checking that SWS = 01.
\end{problem}
\section{PLL}
\begin{problem}
Make the PLL as the system clock.
\end{problem}
\solution
\begin{lstlisting}
RCC->CFGR =0x00000010;	
